...
/**
 * @author wq
 * @since 2021-12-15 9:51
 *暂时不通
 */

public class RandomSexAndAge {
    ...
    public static void main(String[] args) {
        String s = randFamilyName();
        String sex = randSex();
        String name = randName("男");
        System.out.println(s + "\t" + sex + "\t" + name);
    }
    public static String randFamilyName() {
        String str = "";
        int strLen;
        //int randNum = new Random().nextInt(2) + 1 ;  //下面两步一起写的
        Random r = new Random() ;
        ...
        if (randNum == 1) {
            ...
            if (index % 2 == 0) {
                ...
                str = firstName2.substring(index + 1, index + 2);
            }
        }
        return str;
    }
