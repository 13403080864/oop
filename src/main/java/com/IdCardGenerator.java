...
public class IdCardGenerator {
    ...
    public int randomAreaCode() {
        ...
        int code;
        for(code = 0; i < index && it.hasNext(); code = (Integer)it.next()) {
            ++i;
        }
    ...
    public String randomBirthday() {
        ...
        long month = (long)(birthday.get(2) + 1);
        if (month < 10L) {
            builder.append("0");
        }

        builder.append(month);
        long date = (long)birthday.get(5);
        if (date < 10L) {
            builder.append("0");
        }
    ...
    public static void main(String[] args) {
        IdCardGenerator DebtorInfoidcardNo1 = new IdCardGenerator();
        String DebtorInfoidcardNo = DebtorInfoidcardNo1.generate();
        System.out.println(DebtorInfoidcardNo);
    }
