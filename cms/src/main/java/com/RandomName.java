...
public class RandomName {
    ...
    public static String getUserName(int x){
        ...
        for (int i = 0; i < x; i++) {
            ...
            nextInt = random.nextInt(userName.length);
            str = sb.append(userName[nextInt]).toString();
        }
        return str;
    }
    ...
    public static String getChineseName() {
        ...
        String name = null;
        Random random = new Random();
        int highPos = 176 + Math.abs(random.nextInt(72));
        random = new Random();
